...
declare class StaticMCPGenerator {
    ...
    processMarkdownDirectory(dirPath: string, type: string, inputPath: string): Promise<void>;
    getMarkdownFiles(dirPath: string): Promise<string[]>;
    processMarkdownFile(filePath: string, type: string, inputPath: string): Promise<void>;
